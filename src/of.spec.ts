...
describe("of", () => {
  ...
  it.skip("should create a cold observable that emits 1, 2, 3", () => {
  ...
  it.skip("should create an observable from the provided values", (done) => {
    const x = { foo: "bar" };
  ...
  it.skip("should emit one value", (done) => {
    let calls = 0;
